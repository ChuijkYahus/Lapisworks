...
- "What's an SMindInfusion"?
    For now, any recipe that the pattern Imbue Mind uses or can use.  
    Prime examples in `MakeBuddingAmethyst.java` and `UnflayVillager.java`.
